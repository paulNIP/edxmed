                ...
                <tr>
                    ...
                    <td>
                        @php
                            ...
                            $customerAvatar = $review->user != null ? uploaded_asset($review->user->avatar_original) : asset('assets/img/avatar-place.png');
                        @endphp
                        <div class="row gutters-5 w-200px w-md-300px mw-100 align-items-center">
                            <div class="col-auto">
                                <img src="{{ $customerAvatar }}" class="size-50px img-fit rounded-circle" alt="Image" onerror="this.onerror=null;this.src='{{ asset('assets/img/avatar-place.png') }}';">
                            </div>
                            <div class="col">
