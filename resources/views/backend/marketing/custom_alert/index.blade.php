        ...
        <div class="row">
                ...
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ asset('assets/img/alerts/alert-bottom-left.png') }}" class="h-100 w-100" alt="alert">
                        </div>
                    </span>
                </label>
                <br>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ asset('assets/img/alerts/alert-bottom-right.png') }}" class="h-100 w-100" alt="alert">
                        </div>
                    </span>
                </label>
                <br>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ asset('assets/img/alerts/alert-top-left.png') }}" class="h-100 w-100" alt="alert">
                        </div>
                    </span>
                </label>
                <br>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                <label class="aiz-megabox mb-3">
                    ...
                    <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ asset('assets/img/alerts/alert-top-right.png') }}" class="h-100 w-100" alt="alert">
                        </div>
                    </span>
                </label>
                <br>
