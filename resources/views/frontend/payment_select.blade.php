                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                    ...
                                    @endif
                                                                        ...
                                                                        <!-- MTN -->
                                    @if (get_setting('MTN') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="mtn" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ asset('assets/img/cards/MTN_d0c8216900.svg') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15"> MTN </span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    ...
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15"> ELOICA WALLET </span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    @endif
                                                                        ...
                                                                        <!-- visa -->
                                    @if (get_setting('VISA') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="VISA" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/paymob.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15"> VISA </span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    @endif
                                                                        ...
                                                                        <!-- mastercard -->
                                    @if (get_setting('MASTER CARD') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="MASTER CARD" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/paymob.png') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15"> MASTERCARD </span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
                                    @endif
                                                                                                            ...
                                                                                                            <!-- mastercard -->
                                    <!-- @if (get_setting('AIRTEL') == 1)
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="AIRTEL" class="online_payment" type="radio"
                                                    name="payment_option" >
                                                <span class="d-block aiz-megabox-elem p-3">
                                                    <img src="{{ static_asset('assets/img/cards/airtel_8883e48b06.svg') }}"
                                                        class="img-fluid mb-2">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15"> AIRTEL </span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
