                ...
                @foreach($conversation->messages as $message)
                    <li class="list-group-item px-0">
                        <div class="media mb-2">
                          <img class="avatar avatar-xs mr-3" @if($message->sender != null) src="{{ uploaded_asset($message->sender->avatar_original) }}" @endif onerror="this.onerror=null;this.src='{{ asset('assets/img/avatar-place.png') }}';">
