                ...
                <tbody class="fs-14">
                    ...
                    <tr class="align-middle text-center">
                        ...
                        <td class="pl-0 d-flex align-items-center">
                            <div class="col-auto">
                                <img src="{{ uploaded_asset($order->preorder_product?->thumbnail) }}" alt="Image" class="size-50px img-fit" onerror="this.onerror=null;this.src='{{ asset('assets/img/placeholder.jpg') }}';">
                            </div>
                            <div class="col">
