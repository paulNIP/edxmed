...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::withoutMiddleware([EnsureSystemKey::class])->group(function () {
        ...
        Route::controller(YoPaymentController::class)->group(function () {
            Route::post('/yopayments/initiate', 'initiate_yo_payment')->name('yopayments.initiate');

        });

        Route::controller(PesaPalPaymentController::class)->group(function () {
            Route::post('/pesapal/initiate', 'initiate_pesa_payment')->name('pesapal.initiate');
